function [pred,beta] = LARS_pred(y,x,p,h);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% Output:
% pred:   sequence of h-step ahead predictions (\hat y_{T+h}+...+y_{T+1})/h, for all number of predictors
% beta:   sequence of estimated regression coeffiencients (on standardized data) for all number of predictors
...
pred = (XX(end,:)*beta')*sy+my; %% Computes the forecasts